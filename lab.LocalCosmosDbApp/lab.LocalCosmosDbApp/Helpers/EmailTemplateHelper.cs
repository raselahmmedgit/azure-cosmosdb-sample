...
namespace lab.LocalCosmosDbApp.Helpers
{
    public static class EmailTemplateHelper
    {
        ...
        public static string GetContactSendMessageEmailTemplate(string title = "App - Contact Us!", ContactUsModel contactUsModel = null)
        {
            string html = string.Empty;
            ...
            if (contactUsModel != null)
            {
                ...
                html += $"Email : {contactUsModel.ContactEmail}";
                html += "</h5>";
                html += "<h5 style='line-height: 18px; font-size: 16px; font-weight: 400; margin-bottom: 5px;'>";
                html += $"Name : {contactUsModel.ContactName}";
                html += "</h5>";
                html += "<h5 style='line-height: 18px; font-size: 16px; font-weight: 400; margin-bottom: 5px;'>";
                html += $"Phone : {contactUsModel.ContactPhone}";
                html += "</h5>";
                html += "<h5 style='line-height: 18px; font-size: 16px; font-weight: 400; margin-bottom: 5px;'>";
                html += $"Subject : {contactUsModel.ContactSubject}";
                html += "</h5>";
                html += "<h5 style='line-height: 18px; font-size: 16px; font-weight: 400; margin-bottom: 5px;'>";
                html += $"Message : {contactUsModel.ContactMessage}";
                html += "</h5>";
                html += "</div>";
                html += "</td>";
