namespace lab.LocalCosmosDbApp.Helpers
{
    public class Result
    {
        ...
        private Result(bool success, string message, string messageType, string uploadPath)
        {
            Success = success;
            Message = message;
            MessageType = messageType;
        ...
        public static Result Ok(string message, string uploadPath)
        {
            return new Result(true, message, MessageHelper.MessageTypeSuccess, uploadPath);
        }
    }
}
