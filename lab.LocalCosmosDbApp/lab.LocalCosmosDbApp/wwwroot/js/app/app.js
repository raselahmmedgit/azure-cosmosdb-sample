...
$('body').on('click','.nav-menu-header',
    function (e) {
        if ($(this).attr("id") == "client_payment_menu") {
            return;
        }
        else {
            $(".nav-menu-header").each(function () {
...
var App = function () {
    ...
    var actionHandler = function () {
        ...
        $("body").on("click", ".loader-show", function () {
            App.LoaderShow();
        });
        $("body").on("click", ".loader-hide", function () {
            App.LoaderHide();
        });
    };
